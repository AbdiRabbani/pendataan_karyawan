...
<div class="container-fluid">
    <form action="{{route('leave.store')}}" method="post" class="col-md-6">
        ...
        <input type="text" name="name" id="dataLeave" class="form-control border p-2">
        
        <label for="dataStart">leave start date *M/D/Y</label>
        <input type="date" name="start_leave" id="dataStart" class="form-control border p-2">

        <label for="dataEnd">leave end date *M/D/Y</label>
        <input type="date" name="end_leave" id="dataEnd" class="form-control border p-2">
