    ...
    <form class="form" action="{{route('user.update', $user->id)}}" method="post">
        ...
        <div class="col-md-12 row d-flex">
            <div class="col-md-4" id="formContent">
                ...
                <input required name="name" type="text" id="dataName" class="border p-2 form-control mb-3" value="{{$user->name}}">
                <label for="dataEmail">EMail</label>
                <input required name="email" type="email" id="dataEmail" class="border p-2 form-control mb-3" value="{{$user->email}}">
                ...
                <input required name="password" type="password" id="dataPassword" class="border p-2 form-control mb-3" placeholder="Input new password">
            </div>
        </div>
