                    ...
                    <div class="card card-plain h-100">
                        ...
                        <div class="card-body p-3">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">NIP</strong>
                                    &nbsp; 1234</li>
                                ...
                                <li class="list-group-item border-0 ps-0 text-sm"><strong
                                        ...
                                        <li class="list-group-item border-0 ps-0 text-sm"><strong
                                        class="text-dark">KTP No:</strong> &nbsp; 1234567890987654</li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-xl-4">
                    <div class="card card-plain h-100">
                        ...
                        <div class="card-body p-3">
                            <ul class="list-group">
                                <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong
                                        class="text-dark">Birth Date:</strong> &nbsp; Feb 13 2023</li>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-md-0 mb-4">
                                    <div
                                        ...
                                        <img class="w-10 me-3 mb-0" src="{{asset('template/img/logos/mastercard.png')}}"
                                            alt="logo">
                                        <h6 class="mb-0">
                                            ****&nbsp;&nbsp;&nbsp;****&nbsp;&nbsp;&nbsp;****&nbsp;&nbsp;&nbsp;7852</h6>
                                ...
                                <div class="col-md-6">
                                    <div
                                        class="card card-body border card-plain border-radius-lg d-flex align-items-center flex-row">
                                        <img class="w-10 me-3 mb-0" src="{{asset('template/img/logos/visa.png')}}"
                                            alt="logo">
                                        <h6 class="mb-0">
                                            ****&nbsp;&nbsp;&nbsp;****&nbsp;&nbsp;&nbsp;****&nbsp;&nbsp;&nbsp;5248</h6>
                                        <i class="material-icons ms-auto text-dark cursor-pointer"
